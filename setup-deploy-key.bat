@echo off
REM Deploy Key Setup Script for gova
...
set "sshLocalPath=%USERPROFILE%\.ssh_local\gova"

echo.
echo ========================================
echo Deploy Key Setup - gova
echo ========================================
echo.
...
echo       https://github.com/userphone101112-droid/gova/settings/keys
...
:help
echo Deploy Key Setup Script for gova
echo.
