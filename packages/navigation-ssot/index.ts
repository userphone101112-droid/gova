    ...
    items: [
      {
        ...
        type: 'link',
        label: 'Home',
        translationKey: 'marketplace.home',
        route: 'home',
        icon: 'home',
      ...
      },
      {
        ...
        type: 'link',
        label: 'Cart',
        translationKey: 'marketplace.cart',
        route: 'cart',
        icon: 'shopping-cart',
        permissions: ['cart.read', 'marketplace.read'],
        feature: 'marketplace-navigation',
        children: [],
        order: 2,
        hidden: false,
      ...
      },
      {
        ...
        type: 'link',
        label: 'Dashboard',
        translationKey: 'marketplace.dashboard',
      ...
      },
      {
        ...
        type: 'link',
        label: 'Admin',
        translationKey: 'marketplace.admin',
        route: 'admin-dashboard',
        icon: 'shield-check',
        permissions: ['admin.read', 'marketplace.read'],
        feature: 'marketplace-navigation',
        children: [],
        order: 2,
        hidden: false,
      ...
      },
      {
        ...
        type: 'link',
        label: 'Notifications',
        translationKey: 'marketplace.notifications',
        route: 'notifications',
        icon: 'bell',
      ...
      },
      {
        ...
        type: 'link',
        label: 'Profile',
        translationKey: 'marketplace.profile',
        route: 'profile',
        icon: 'user',
        permissions: ['user.read', 'marketplace.read'],
        feature: 'marketplace-navigation',
        children: [],
        order: 4,
        hidden: false,
