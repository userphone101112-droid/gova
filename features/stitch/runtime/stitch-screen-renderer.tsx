import type { StitchRouteEntry } from '../routes/stitch-route-map'

type StitchScreenRendererProps = {
  screen: StitchRouteEntry
}

export function StitchScreenRenderer({ screen }: StitchScreenRendererProps) {
  return (
    <main style={{ 
      padding: '48px 24px', 
      maxWidth: '800px', 
